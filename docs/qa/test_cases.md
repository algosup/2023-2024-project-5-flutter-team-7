...
|C-01-02|First Page|The user clicks on the "Inscription" button|The user is redirected to the registration page|:x:|
|C-01-03|First Page|The user clicks on the "Passer au mode chercheur d'emploi" button|The user enters the job seeker mode|:x:|
...
|C-02-15|Sign in|All the required fields are filled with valid information|The user is redirected to the next page|:x:|
...
|C-04-02|Profile|The user clicks on the "Modifier mes offres d'emploi" button|The user can modify his job offers|:x:|
...
|C-05-01|Job Offers|The user clicks on the "Ajouter une offre d'emploi" button|The user is redirected to the job offer creation page|:x:|
|C-05-02|Job Offers|The user clicks on one of is already created offers|The user is redirected to selected job offers|:x:|
|C-06-01|Soft Skills|The user selects no soft skills|An error message appears asking to select at least one|:x:|
|C-06-02|Soft Skills|The user selects more than 8 soft skills|An error message appears asking to select at most 8|:x:|
|C-06-03|Soft Skills|The user selects between 1 and 8 soft skills|The user is redirected to the next page|:x:|
